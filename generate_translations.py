...
# Hyperparameters
weights = '/raid/cristinam/da_kpn_experiments/saved_models/segmentation/cityscapes_segmentation_sourceonly/net_epoch_10'
...
# Data
data_set = CityscapesGTADataset('generate', full_resolution, low_resolution, patch_scale_factor, fold_params, model_type)
...
with torch.no_grad():
    for i, data in enumerate(data_loader):
        ...
        full_transformed = torch.zeros(3, kernel_size[0], kernel_size[1], num_patches)
